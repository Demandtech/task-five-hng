...
const Social = () => {
  return (
    <div className='text-center flex flex-col items-center'>
      <div className='border border-primary flex w-full justify-center py-2 mb-5 rounded-md gap-3'>
        <svg
      ...
      <div className='border border-primary flex justify-center w-full py-2 rounded-md gap-3'>
        <svg
          xmlns='http://www.w3.org/2000/svg'
          width='25'
          height='24'
      ...
      <div className='h-[1px] bg-[#B9C2C8] w-full mt-8 lg:mt-10 '>
